  ...
  <div class="flex flex-wrap place-items-center h-auto">
    <!-- card con estilos propios -->
    {{--}}  <div class="overflow-hidden shadow-lg transition duration-500 ease-in-out 
    transform hover:-translate-y-5 hover:shadow-2xl
     rounded-lg h-90 w-60 md:w-80 cursor-pointer m-auto">
      {{--}}
   
    <div {{$attributes->merge(['class' =>'overflow-hidden shadow-lg transition
     duration-500 ease-in-out 
        ...
        <a href="#" class="w-full block h-full">
            ...
            <div class="bg-white w-full p-4">
                ...
                @else
                <div class="flex flex-wrap justify-starts items-center py-3 border-b-2 text-xs text-white font-medium">
                <span class="text-black">No hay etiquetas
                </span>
                </div>
                @endif
